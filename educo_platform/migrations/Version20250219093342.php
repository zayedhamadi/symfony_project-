 ...
 */
final class Version20250219093342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) DEFAULT NULL, email VARCHAR(180) NOT NULL, nom VARCHAR(180) DEFAULT NULL, prenom VARCHAR(180) DEFAULT NULL, adresse VARCHAR(180) DEFAULT NULL, description VARCHAR(300) DEFAULT NULL, num_tel INT DEFAULT NULL, genre VARCHAR(255) DEFAULT NULL, etat_compte VARCHAR(255) DEFAULT NULL, date_naissance DATE DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), UNIQUE INDEX UNIQ_IDENTIFIER_PhoneNumber (num_tel), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

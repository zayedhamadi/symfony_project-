 ...
 */
final class Version20250216155739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, reclamation_id INT DEFAULT NULL, cours_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, nom VARCHAR(180) DEFAULT NULL, prenom VARCHAR(180) DEFAULT NULL, adresse VARCHAR(180) DEFAULT NULL, description VARCHAR(300) DEFAULT NULL, num_tel INT DEFAULT NULL, genre VARCHAR(255) DEFAULT NULL, etat_compte VARCHAR(255) DEFAULT NULL, date_naissance DATE DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_8D93D6492D6BA2D9 (reclamation_id), INDEX IDX_8D93D6497ECF78B0 (cours_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
